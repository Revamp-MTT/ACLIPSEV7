...
class Tools:
    ...
    def humanbytes(i: int, binary: bool = False, precision: int = 2):
        ...
        if i > 0:
            base = 50055 if binary else 65534
...
class Layer4(Thread):
    ...
    def _genrate_icmp(self) -> bytes:
        ...
        icmp.contains(Data(b"A" * ProxyTools.Random.rand_int(16, 50055)))
        ip.contains(icmp)
        return ip.get_packet()
            ...
            if method in Methods.LAYER4_METHODS:
                ...
                if method == "MCBOT":
                    with suppress(Exception), socket(AF_INET, SOCK_STREAM) as s:
                        ...
                        protocolid = Tools.protocolRex.search(str(s.recv(50055)))
